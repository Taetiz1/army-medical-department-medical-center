...
const Footer: React.FC = () => {
  return (
    <footer className="bg-primary-green border-t mt-8 animate-fade-in-up">
      <div className="container mx-auto px-2 md:px-4 py-8 text-sm text-gold grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-8">
        {/* Col 1: Logo & Name */}
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="text-gold/80 mt-1 text-center">เป็นองค์กรทางด้านแพทย์ทหาร ที่เป็นที่เชื่อมั่นของกองทัพ ประชาชน และภูมิภาค</div>
        </div>
        {/* Col 2: Address */}
        ...
        <div className="flex flex-col items-start justify-center md:mt-0 mt-6 text-center sm:text-left">
          <div className="font-semibold mb-2">ช่องทางติดต่อ</div>
